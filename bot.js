...
client.on('message', msg => {
    if (msg.content === 'ping') {
        msg.reply('Pong!');
    } else if(msg.content.toLowerCase() == "!purr"){
        ...
        }else if(msg.content.toLowerCase().includes("good") && msg.content.toLowerCase().includes("bot")){
        ...
        }else if (msg.content.toLowerCase().includes("bad") && msg.content.toLowerCase().includes("bot")){
        const MessMessage = [">:(","*mad","https://media3.giphy.com/media/fR8aQPQViGQ10aGdpK/giphy.gif?cid=ecf05e47tax2yteqia4tk4gcl50sp49g1nn6x595wesvgqrp&rid=giphy.gif&ct=g", "B*tch", "Meow"]
        msg.channel.send(MessMessage[Math.floor(Math.random()*MessMessage.length)])

    } else if (msg.author.id == "531799714589442068" && msg.content.toLowerCase().includes("test") && msg.content.toLowerCase().includes("100")) {
